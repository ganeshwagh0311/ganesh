const Button = () => {
  return (
    <button
      className="font-semibold text-white rounded-lg py-2 px-4 w-full sm:w-1/2 hover:py-5 cursor-pointer border-none bg-[#70bdca] flex justify-center items-center relative overflow-hidden hover:shadow-2xl hover:bg-[#70bdca] text-sm sm:text-base"
